...
export default function TwitterCard({ username, onBack }: TwitterCardProps) {
  ...
  if (!user) {
    return (
      <div className="text-center p-8">
        ...
        <p className="text-gray-600 mb-6">The username &ldquo;{username}&rdquo; could not be found or is private.</p>
        <button
          onClick={onBack}
  ...
  return (
    <div className="w-full max-w-2xl mx-auto space-y-6">
      ...
      <div 
        ref={cardRef}
        className="relative max-w-md mx-auto rounded-3xl shadow-2xl overflow-hidden border border-gray-100"
      >
        ...
        <div className="relative p-8  rounded-2xl m-6">
          {/* Profile Section */}
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-300 mb-1">{user.name}</h2>
